...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(510, 418)
        icon = QIcon()
        icon.addFile(u"C:/Users/user/Videos/Captures/key_black_24dp.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/C:/Users/user/Videos/Captures/lock_FILL0_wght400_GRAD0_opsz48.svg", QSize(), QIcon.Disabled, QIcon.On)
...
"")
        ...
        sizePolicy2.setHeightForWidth(self.btn_visibility.sizePolicy().hasHeightForWidth())
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/icons/C:/Users/user/Videos/Captures/visibility_off_FILL0_wght400_GRAD0_opsz48.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon2.addFile(u":/icons/C:/Users/user/Videos/Captures/visibility_FILL0_wght400_GRAD0_opsz48.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        sizePolicy2.setHeightForWidth(self.btn_refresh.sizePolicy().hasHeightForWidth())
        self.btn_refresh.setSizePolicy(sizePolicy2)
...
"")
        icon3 = QIcon()
        icon3.addFile(u":/icons/C:/Users/user/Videos/Captures/refresh_FILL0_wght400_GRAD0_opsz48.svg", QSize(), QIcon.Normal, QIcon.On)
...
"")
        icon4 = QIcon()
        icon4.addFile(u":/icons/C:/Users/user/Videos/Captures/content_copy_FILL0_wght400_GRAD0_opsz48.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        sizePolicy3.setHeightForWidth(self.label_strength.sizePolicy().hasHeightForWidth())
        self.label_strength.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.label_entropy.sizePolicy().hasHeightForWidth())
        self.label_entropy.setSizePolicy(sizePolicy3)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_digits.setText(QCoreApplication.translate("MainWindow", u"a-z", None))
        self.btn_lower.setText(QCoreApplication.translate("MainWindow", u"A-Z", None))
        self.btn_upper.setText(QCoreApplication.translate("MainWindow", u"0-9", None))
